...
The development spans Euclidean Sobolev compactness, measure/Lp transport, chart localization,
and the Riemannian specialization. The files are organized so these parts can be studied
independently before the final compact-embedding theorem.
